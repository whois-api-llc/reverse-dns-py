...
class ReverseDnsApiError(Exception):
...
class ParameterError(ReverseDnsApiError):
    pass


class EmptyApiKeyError(ReverseDnsApiError):
    pass


class ResponseError(ReverseDnsApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(ReverseDnsApiError):
...
class HttpApiError(ReverseDnsApiError):
    pass
